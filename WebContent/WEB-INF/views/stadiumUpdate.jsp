...
<body>
	<form  method="post"
		action="${pageContext.request.contextPath}/stadiumUpdate.do ">

		场地号：${stadium.id}<input type="hidden" name="id" value="${stadium.id}"><br>
		场地名：<input type="text" name="name" value="${stadium.name}"><br>
                面积：<input type="text" name="area" value="${stadium.area}"><br>
