...
<div class="login" style="margin-top:50px;">
    ...
    <div class="header" style="background-color:orange; margin-right:100px;">
  ...
  <!--注册-->
    ...
    <div class="web_login">
    <form name="form2" id="regUser" accept-charset="utf-8"  action="${pageContext.request.contextPath}/reg.do" method="post">
